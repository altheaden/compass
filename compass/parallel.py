...
def run_command(args, cpus_per_task, ntasks, openmp_threads, mem, config,
                logger):
    """
    ...
    mem : str
        the amount of memory the process is allowed to use
    ...
    logger.info(f'running: {" ".join(command_line_args)}')
